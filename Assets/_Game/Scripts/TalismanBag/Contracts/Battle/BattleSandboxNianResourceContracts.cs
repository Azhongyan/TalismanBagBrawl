...
namespace TalismanBag.Contracts.Battle
{
    ...
    public sealed class BattleSandboxNianActualItemCostPulseRequest
    {
        public const string CurrentSchemaId =
            "BattleSandboxNianActualItemCostPulseRequest.v1";

        public BattleSandboxNianActualItemCostPulseRequest(
            string schemaId,
            string itemRequestEventId,
            int expectedResetGeneration,
            string expectedSourceCanonicalSignature,
            string baseItemId,
            string expectedCostRequestFactId,
            long battleTick)
        {
            ...
            this.itemRequestEventId = itemRequestEventId ?? string.Empty;
            this.expectedResetGeneration = expectedResetGeneration;
            this.expectedSourceCanonicalSignature =
                expectedSourceCanonicalSignature ?? string.Empty;
            this.baseItemId = baseItemId ?? string.Empty;
            this.expectedCostRequestFactId =
                expectedCostRequestFactId ?? string.Empty;
            this.battleTick = battleTick;
        }

        public string schemaId { get; }
        public string itemRequestEventId { get; }
        public int expectedResetGeneration { get; }
        public string expectedSourceCanonicalSignature { get; }
