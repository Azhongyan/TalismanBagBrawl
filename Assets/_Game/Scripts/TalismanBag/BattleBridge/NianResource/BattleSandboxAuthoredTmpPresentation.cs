...
namespace TalismanBag.BattleBridge.NianResource
{
        ...
        IBattleSandboxAcceptedDamagePresentation
    {
        ...
        public string EventId => pulseEventId;
        public int ResetGeneration => resetGeneration;
        public long BattleTick => battleTick;
        public string SourceRequestId => damageLedgerEventId;
        public string SourceBaseItemId => sourceBaseItemId;
        public string SourceItemInstanceId => sourceItemInstanceId;
        public string SourcePlacementId => sourcePlacementId;
        public int ResolvedPreMitigationDamageUnits =>
            resolvedPreMitigationDamageUnits;
        public int ShellDamageApplied => shellDamageApplied;
        public int HpDamageApplied => hpDamageApplied;
        public int TotalDamageApplied => totalDamageApplied;
        public bool ShellBreakApplied => false;
