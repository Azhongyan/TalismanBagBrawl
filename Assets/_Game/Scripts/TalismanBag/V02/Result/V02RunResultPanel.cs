...
namespace TalismanBag.V02.Result
{
    public sealed class V02RunResultPanel : MonoBehaviour
    {
        ...
        public void ShowWin(V02RunStatsTracker stats)
        {
            Show();
            SetText(titleText, "\u901a\u5173\u6210\u529f");
            SetText(summaryText, "\u4f60\u5b8c\u6210\u4e86 7 \u573a\u9635\u6cd5\u5bf9\u6297\u3002\n\u8bc4\u4ef7\uff1a\u9635\u6cd5\u5df2\u5177\u5907\u57fa\u7840\u5bf9\u6297\u80fd\u529b\u3002");
            SetText(reasonText, "\u672c\u5c40\u6838\u5fc3\u8868\u73b0");
            SetText(detailText, stats != null ? stats.BuildSummary() : string.Empty);
        }

        public void ShowLose(int roundIndex, string roundTitle, V02FailureReasonResult reason, V02RunStatsTracker stats)
        {
            Show();
            string title = string.IsNullOrWhiteSpace(roundTitle) ? $"Round {roundIndex}" : $"Round {roundIndex} / 7  {roundTitle}";
