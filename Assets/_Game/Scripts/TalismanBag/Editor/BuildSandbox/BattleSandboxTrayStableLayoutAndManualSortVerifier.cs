...
namespace TalismanBag.Editor.BuildSandbox
{
    ...
    /// It does not invoke a scene builder or write Unity assets.
    /// </summary>
    [InitializeOnLoad]
    public static class BattleSandboxTrayStableLayoutAndManualSortVerifier
    {
        ...
        private static void SettleTargetSceneBeforePlay()
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException(
                        "TARGET_PREPLAY_SCENE_HAS_UNSAVED_CHANGES");
                }
            ...
            ICollection<string> evidence)
        {
            ...
            evidence.Add(
                "roster=30+I031; deterministic-master=true; placements="
                + first.Placements.Count.ToString(
                    CultureInfo.InvariantCulture));
        }
