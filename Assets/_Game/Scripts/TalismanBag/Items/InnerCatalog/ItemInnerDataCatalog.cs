...
namespace TalismanBag.Items.InnerCatalog
{
    public static class ItemInnerDataCatalog
    {
        ...
        private static readonly List<ItemInnerDataDefinition> Items = new()
        {
            ...
            CreateFaMenItem("I002", "五雷急符", ItemFaMenTag.Zhenlei, ItemQiLeiTag.Fu, "shape_line2_h", Line2H, new Vector2Int(0, 0), ItemCatalogRarity.Qing, "急雷连引", "连续触发时提高雷法出手频率预览。"),
            ...
            CreateFaMenItem("I004", "五雷急令", ItemFaMenTag.Zhenlei, ItemQiLeiTag.Ling, "shape_line2_h", Line2H, new Vector2Int(1, 0), ItemCatalogRarity.Lan, "急令催发", "条件满足时催发一次震雷令文。"),
            ...
            CreateFaMenItem("I006", "天鼓槌", ItemFaMenTag.Zhenlei, ItemQiLeiTag.Fa, "shape_line2_h", Line2H, new Vector2Int(0, 0), ItemCatalogRarity.Zi, "天鼓震鸣", "周期性震鸣，作为震雷大件预览。"),
            ...
            CreateFaMenItem("I009", "离火焚邪印", ItemFaMenTag.Lihuo, ItemQiLeiTag.Yin, "shape_line2_h", Line2H, new Vector2Int(0, 0), ItemCatalogRarity.Lan, "焚邪压印", "印心落火，强化离火持续段预览。"),
            CreateFaMenItem("I010", "风火令旗", ItemFaMenTag.Lihuo, ItemQiLeiTag.Ling, "shape_line2_v", Line2V, new Vector2Int(0, 1), ItemCatalogRarity.Lan, "风火起令", "以令旗带起短促风火节奏。"),
            CreateFaMenItem("I011", "照焚铜镜", ItemFaMenTag.Lihuo, ItemQiLeiTag.Jing, "shape_line2_h", Line2H, new Vector2Int(1, 0), ItemCatalogRarity.Lan, "照焚回光", "镜照后留下离火余焰预览。"),
            ...
            CreateFaMenItem("I014", "镇宅长符", ItemFaMenTag.Zhongyue, ItemQiLeiTag.Fu, "shape_line3_h", Line3H, new Vector2Int(1, 0), ItemCatalogRarity.Qing, "镇宅连符", "横向镇守，提供中岳稳固预览。"),
            CreateFaMenItem("I015", "中岳镇守章", ItemFaMenTag.Zhongyue, ItemQiLeiTag.Yin, "shape_corner3", Corner3, new Vector2Int(0, 0), ItemCatalogRarity.Lan, "镇守落章", "章印落定后提供镇守防护预览。"),
            CreateFaMenItem("I016", "护坛令旗", ItemFaMenTag.Zhongyue, ItemQiLeiTag.Ling, "shape_line2_v", Line2V, new Vector2Int(0, 1), ItemCatalogRarity.Lan, "护坛号令", "令旗立坛，提供短时护坛预览。"),
            CreateFaMenItem("I017", "照邪八卦镜", ItemFaMenTag.Zhongyue, ItemQiLeiTag.Jing, "shape_line3_v", Line3V, new Vector2Int(0, 1), ItemCatalogRarity.Lan, "照邪定影", "照出邪影并提供防护判断预览。"),
            ...
            CreateFaMenItem("I021", "玄水涤秽印", ItemFaMenTag.Xuanshui, ItemQiLeiTag.Yin, "shape_line2_h", Line2H, new Vector2Int(0, 0), ItemCatalogRarity.Lan, "涤秽印心", "以印心凝水，提供清秽回护预览。"),
            CreateFaMenItem("I022", "玄水流令", ItemFaMenTag.Xuanshui, ItemQiLeiTag.Ling, "shape_line2_v", Line2V, new Vector2Int(0, 1), ItemCatalogRarity.Lan, "流令回转", "令文流转，提供节奏回转预览。"),
            CreateFaMenItem("I023", "照秽水镜", ItemFaMenTag.Xuanshui, ItemQiLeiTag.Jing, "shape_line2_h", Line2H, new Vector2Int(1, 0), ItemCatalogRarity.Lan, "照秽成涟", "镜照秽气并触发水涟预览。"),
            CreateFaMenItem("I024", "净水盂", ItemFaMenTag.Xuanshui, ItemQiLeiTag.Fa, "shape_corner3", Corner3, new Vector2Int(0, 0), ItemCatalogRarity.Zi, "净盂蓄水", "玄水大件，蓄水净化与回护预览。"),
            ...
            CreateFaMenItem("I026", "太白斩符", ItemFaMenTag.Taibai, ItemQiLeiTag.Fu, "shape_line2_h", Line2H, new Vector2Int(0, 0), ItemCatalogRarity.Qing, "太白斩符", "以符气形成一次斩击预览。"),
            ...
            CreateFaMenItem("I028", "断煞令", ItemFaMenTag.Taibai, ItemQiLeiTag.Ling, "shape_line2_h", Line2H, new Vector2Int(1, 0), ItemCatalogRarity.Lan, "断煞号令", "令文触发断煞窗口预览。"),
            CreateFaMenItem("I029", "照煞镜", ItemFaMenTag.Taibai, ItemQiLeiTag.Jing, "shape_line2_v", Line2V, new Vector2Int(0, 1), ItemCatalogRarity.Lan, "照煞回锋", "镜中照煞并形成回锋预览。"),
            CreateFaMenItem("I030", "桃木剑", ItemFaMenTag.Taibai, ItemQiLeiTag.Fa, "shape_line3_h", Line3H, new Vector2Int(1, 0), ItemCatalogRarity.Zi, "桃木斩邪", "太白大件，以桃木剑斩邪预览。"),
