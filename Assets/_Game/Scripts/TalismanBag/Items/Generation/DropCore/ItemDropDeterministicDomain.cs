...
{
    public static class ItemDropDeterministicDomain
    {
            ...
            out ulong domainSeed)
        {
            ...
            AppendString(ref hash, requestId.Trim());
            AppendString(ref hash, sourceContextId.Trim());
            AppendString(ref hash, sourceKey.Trim());
            AppendUInt32(ref hash, unchecked((uint)sourceOrdinal));
