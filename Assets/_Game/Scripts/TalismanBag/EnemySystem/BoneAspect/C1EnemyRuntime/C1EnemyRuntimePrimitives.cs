...
namespace TalismanBag.EnemySystem.BoneAspect.C1EnemyRuntime
{
    ...
    {
        public const string SchemaId = "BoneAspectC1EnemyRuntime.v2";
        ...
        public const int PlayableItemApplicationCadenceFixtureTicks = 1500;
        public const int DeathPresentationHoldRecommendationTicks = 1500;
        ...
        public const string ShatteredHostSkillActionId =
        ...
        public const string PollutedPulseSkillRequest =
    ...
    public sealed class C1EnemyActionScheduleStateSnapshot
    {
        public C1EnemyActionScheduleStateSnapshot(
            string actionPatternId,
            long nextDueTick,
            int executionCount,
            long lastStartTick)
        ...
        public string ActionPatternId { get; private set; }
        public long NextDueTick { get; private set; }
        public int ExecutionCount { get; private set; }
        public long LastStartTick { get; private set; }

        internal C1EnemyActionScheduleStateSnapshot WithStarted(
            long nextDueTick,
            long startTick)
        {
            return new C1EnemyActionScheduleStateSnapshot(
                ActionPatternId,
                nextDueTick,
                ExecutionCount + 1,
                startTick);
    ...
    internal sealed class C1EnemyRuntimeStateData
    {
        ...
        public List<C1EnemyActionScheduleStateSnapshot> ActionScheduleStates =
            new List<C1EnemyActionScheduleStateSnapshot>();
        ...
        public C1EnemyRuntimeStateData Clone()
        {
            ...
            clone.ActionScheduleStates =
                new List<C1EnemyActionScheduleStateSnapshot>(ActionScheduleStates);
