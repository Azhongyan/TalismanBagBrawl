# Synergy Coverage Report

Package: `V0.3/V0.4-BuildSandbox-ConfigValidatorReport01`
Generated: `2026-06-30 22:29:22`
Status: `PASS`
Data label: `devOnly / disabled / coverage only / not formal flow`

## Coverage Counts

- ItemTagConfig: `4`
- SynergyConfig: `3`
- BuildArchetypeConfig: `2`
- Seed snapshot items: `8`
- Active synergies in sample: `3`
- Active thresholds in sample: `6`
...
## Synergy Threshold Coverage

| synergyId | requiredTags | thresholds | modifierOrEventTokens | devOnly | isEnabled |
| --- | --- | --- | --- | --- | --- |
| `bs_synergy_corruption_ward` | `黑炉污染;净厄;镇魂` | `2;4` | `corruption_ward_2_preview;corruption_ward_4_preview` | `True` | `False` |
| `bs_synergy_guardian_energy` | `护阵;聚能;法器` | `2;4;6` | `guardian_energy_2_preview;guardian_energy_4_preview;guardian_energy_6_preview` | `True` | `False` |
| `bs_synergy_lihuo_talisman` | `离火;符箓` | `2;4;6;8` | `li_huo_talisman_2_preview;li_huo_talisman_4_preview;li_huo_talisman_6_preview;li_huo_talisman_8_preview` | `True` | `False` |

## Active Synergy Sample

| synergyId | matchedCount | activeThresholds | placementSatisfied | energySatisfied | sourceItems |
| --- | ---: | --- | --- | --- | --- |
| `bs_synergy_corruption_ward` | 2 | `bs_synergy_corruption_ward:2` | `True` | `True` | `seed_corruption_1;seed_corruption_2` |
| `bs_synergy_guardian_energy` | 6 | `bs_synergy_guardian_energy:2;bs_synergy_guardian_energy:4;bs_synergy_guardian_energy:6` | `True` | `True` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` |
| `bs_synergy_lihuo_talisman` | 4 | `bs_synergy_lihuo_talisman:2;bs_synergy_lihuo_talisman:4` | `True` | `True` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` |
