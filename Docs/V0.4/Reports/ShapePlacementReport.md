# Shape Placement Report

Package: `V0.3/V0.4-BuildSandbox-ItemShapeOccupancy01`
Generated: `2026-06-30 22:29:21`
Status: `PASS`

## Scope

- Pure BuildSandbox data and placement validation only.
- No formal combat, drop, forge, save, boss, reward, numeric, or product-flow connection.
- Energy relation is reported as a sandbox placeholder until a later evaluator package.

## Shape Configs

| shapeId | cellCount | offsets | rotationAllowed | devOnly | isEnabled |
| --- | ---: | --- | --- | --- | --- |
| `Corner3` | 3 | `0,0;1,0;0,1` | `False` | `True` | `False` |
| `Single1` | 1 | `0,0` | `False` | `True` | `False` |
| `Square4` | 4 | `0,0;1,0;0,1;1,1` | `False` | `True` | `False` |
| `Vertical2` | 2 | `0,0;0,1` | `False` | `True` | `False` |

## Placement Samples

| itemId | shapeId | anchorCell | occupiedCells | isValid | invalidReason | adjacentItems | energyConnected |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `shape_single_sample` | `Single1` | `0,0` | `0,0` | `True` | `None` | `` | `sandbox_placeholder:False` |
| `shape_vertical_sample` | `Vertical2` | `2,0` | `2,0;2,1` | `True` | `None` | `` | `sandbox_placeholder:False` |
| `shape_corner_sample` | `Corner3` | `4,0` | `4,0;5,0;4,1` | `True` | `None` | `` | `sandbox_placeholder:False` |
| `shape_square_sample` | `Square4` | `6,0` | `6,0;7,0;6,1;7,1` | `True` | `None` | `shape_corner_sample` | `sandbox_placeholder:False` |
| `shape_out_of_grid_sample` | `Square4` | `7,3` | `7,3;8,3;7,4;8,4` | `False` | `OutOfGrid` | `` | `sandbox_placeholder:False` |
| `shape_overlap_base` | `Single1` | `0,0` | `0,0` | `True` | `None` | `` | `sandbox_placeholder:False` |
| `shape_overlap_sample` | `Vertical2` | `0,0` | `0,0;0,1` | `False` | `CellOccupied` | `` | `sandbox_placeholder:False` |
| `shape_missing_sample` | `MissingShape` | `0,0` | `` | `False` | `MissingShapeConfig` | `` | `sandbox_placeholder:False` |
| `shape_invalid_sample` | `InvalidShape` | `0,0` | `` | `False` | `ShapeInvalid` | `` | `sandbox_placeholder:False` |

## Sandbox Snapshot

- placedItems: `5`
- Every valid placement snapshot carries occupiedCells for later read-only evaluator packages.
...
- Shape seed configs: `devOnly=true` and `isEnabled=false`.
- Shape rotation feature flag remains false; first-batch seeds do not require rotation.
- This package does not implement SynergyEvaluator deep calculation.
