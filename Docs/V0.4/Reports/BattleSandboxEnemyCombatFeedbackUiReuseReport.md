...
- Corrects the previous enemy/Boss topic-panel direction into combat feedback language.
...
- row count: `73`
- player visible row count: `73`
- Boss state rows: `7`
- cast-bar rows: `17`
- floating feedback rows: `73`
- mechanic feedback rows: `26`
- masked answer field count: `6`
- formal leak count: `0`
- feature flags default true: `0`
- V02 scene changes: `0`
- V03 scene changes: `0`

## Feedback Coverage

| Kind | Rows | Cast-Bar Rows | Floating Rows |
| --- | ---: | ---: | ---: |
| `bossSkillCast` | 6 | 6 | 6 |
| `bossState` | 7 | 0 | 7 |
| `enemyState` | 11 | 11 | 11 |
| `failureFeedback` | 17 | 0 | 17 |
| `mechanicFeedback` | 26 | 0 | 26 |
| `weaknessWindow` | 6 | 0 | 6 |
...
| `bossCast.dev_boss_dirty_dream_mother` | `bossSkillCast` | 秽签梦母：正在准备技能 | 施法中：裂甲咒阵 | 施法预兆 | 【施法】裂甲咒阵 即将落下。 |
| `bossCast.dev_boss_spirit_thief_core` | `bossSkillCast` | 偷灵炉心：正在准备技能 | 施法中：魂火压境 | 施法预兆 | 【施法】魂火压境 即将落下。 |
| `bossCast.dev_boss_bronze_formation_general` | `bossSkillCast` | 叩阵铜将：正在准备技能 | 施法中：封印阵眼 | 施法预兆 | 【施法】封印阵眼 即将落下。 |
| `bossCast.dev_boss_paper_faces` | `bossSkillCast` | 纸人千面阵：正在准备技能 | 施法中：回春护幕 | 施法预兆 | 【施法】回春护幕 即将落下。 |
| `bossCast.dev_boss_black_furnace_complex_eye` | `bossSkillCast` | 黑炉复合阵眼：正在准备技能 | 施法中：怒意爆发 | 施法预兆 | 【施法】怒意爆发 即将落下。 |
| `weakness.weak_black_shell_break_3` | `weaknessWindow` | 黑炉护壳师：破绽窗口出现 | 破绽窗口 | 破绽窗口出现 | 【破绽】破绽窗口出现，抓住短暂节奏。 |

## Developer Answer Links

| English Stable Key | Chinese Display Name | Data Panel Slot | Source | Player Visible | Masked From Player |
| --- | --- | --- | --- | --- | --- |
| `hardSolutionTags` | 硬解标签 | `EnemyCombatFeedbackDeveloperPanel` | `BuildProblemSeedDataset.enemyProblems.hardSolutionTags` | `False` | `True` |
| `requiredSynergy` | 必需协同 | `EnemyCombatFeedbackDeveloperPanel` | `BuildProblemSeedDataset.bossProblems.keyRequirements` | `False` | `True` |
| `requiredAffix` | 必需词缀 | `EnemyCombatFeedbackDeveloperPanel` | `BuildProblemSeedDataset.bossProblems.keyRequirements` | `False` | `True` |
| `requiredStats` | 必需属性 | `EnemyCombatFeedbackDeveloperPanel` | `BuildProblemSeedDataset.bossProblems.requiredProblemAttributes` | `False` | `True` |
| `dropBiasWeights` | 定向倾向权重 | `EnemyCombatFeedbackDeveloperPanel` | `BuildProblemSeedDataset.dropBiases.previewWeight` | `False` | `True` |
| `bossSixKeyFullAnswer` | Boss六钥匙完整答案 | `EnemyCombatFeedbackDeveloperPanel` | `BuildProblemSeedDataset.bossProblems.keyRequirements` | `False` | `True` |
...
| `Info` | `COMBAT_FEEDBACK_DEVONLY_TRUE` | Required flag remains true. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_ENABLED_TRUE` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_FLOATING_LANGUAGE_FALSE` | Required flag remains true. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_CAST_BAR_LANGUAGE_FALSE` | Required flag remains true. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_BOSSINFO_LANGUAGE_FALSE` | Required flag remains true. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_TOPIC_PANEL_NOT_REMOVED` | Required flag remains true. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_CHINESE_ONLY_FALSE` | Required flag remains true. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_DEV_PANEL_RULE_FALSE` | Required flag remains true. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_SHOWS_FULL_ANSWERS` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_RUNS_FORMAL_COMBAT` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_CALLS_FORMAL_DAMAGE` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_WRITES_FORMAL_FLOW` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_WRITES_SAVE` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_GRANTS_REWARD` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_ADVANCES_CHAPTER` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_OPENS_FEATURE_FLAG` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_ISOLATION_PASS` | Preview is devOnly, disabled, and disconnected from formal flow/combat/reward/save data. | `BattleSandboxEnemyCombatFeedbackPreview` |
| `Info` | `COMBAT_FEEDBACK_ROW_COUNT` | Combat feedback row count pass. actual=73, expected>=24. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_PLAYER_ROW_COUNT` | Player visible feedback row count pass. actual=73, expected>=24. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_BOSS_STATE_COUNT` | Boss state feedback row count pass. actual=7, expected>=7. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_CAST_BAR_COUNT` | Cast bar feedback row count pass. actual=17, expected>=8. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_FLOATING_COUNT` | Floating feedback row count pass. actual=73, expected>=18. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_MECHANIC_COUNT` | Mechanic feedback row count pass. actual=26, expected>=8. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_MASKED_FIELD_COUNT` | Masked answer field count pass. actual=6, expected>=6. | `V0.4-BattleSandboxEnemyCombatFeedbackUiReuse01` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/PreviousFeedbackButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/PreviousFeedbackButton` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/NextFeedbackButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/NextFeedbackButton` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/TriggerFloatingFeedbackButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/TriggerFloatingFeedbackButton` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/ControlStatusText | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyCombatFeedbackControlPanel/ControlStatusText` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossStateText | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossStateText` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossSkillText | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossSkillText` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossCastBarRoot | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossCastBarRoot` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossCastBarRoot/BossCastFill | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossCastBarRoot/BossCastFill` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossCastBarRoot/BossCastTimerText | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossCastBarRoot/BossCastTimerText` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/CombatLogText | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/CombatLogText` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/PopupLayer/EnemyCombatFeedbackFloatingRoot | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/PopupLayer/EnemyCombatFeedbackFloatingRoot` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/PopupLayer/EnemyCombatFeedbackFloatingRoot/MechanicFloatingText | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/PopupLayer/EnemyCombatFeedbackFloatingRoot/MechanicFloatingText` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyCombatFeedbackDeveloperPanel | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyCombatFeedbackDeveloperPanel` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyCombatFeedbackDeveloperPanel/MaskedDeveloperFieldsText | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyCombatFeedbackDeveloperPanel/MaskedDeveloperFieldsText` |
| `Info` | `COMBAT_FEEDBACK_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewRoot/EnemyCombatFeedbackRuntime | `BuildSandboxPreviewRoot/EnemyCombatFeedbackRuntime` |
| `Info` | `COMBAT_FEEDBACK_CAST_BAR_PASS` | Boss cast bar uses filled Image progress language. | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BattleLikePreviewArea/EnemyCombatFeedbackPanel/BossCastBarRoot/BossCastFill` |
