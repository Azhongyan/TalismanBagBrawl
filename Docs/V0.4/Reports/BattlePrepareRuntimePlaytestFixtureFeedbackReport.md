# BattlePrepare Runtime Playtest Fixture Feedback Report

Package: `V0.4-BattlePrepareComponentAdapterRuntimePlaytest01-FixtureFeedbackFix01`
Base Runtime Package: `V0.4-BattlePrepareComponentAdapterRuntimePlaytest01`
Generated: `2026-07-01 17:42:59`
Status: `FIXTURE_FEEDBACK_BLOCKED`
Errors: `17`
Warnings: `0`
Leak Count: `0`
...
- Fixture QA Menu Path: `Tools/Talisman Bag/V0.4/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest01-FixtureFeedbackFix01/[QA Only] Run Fixture Feedback Validation`
- Target Scene: `Assets/_Game/Scenes/Scene_TalismanBag_V02_FormationCounter.unity`
- createsRuntimeFixtureProvider: `True`
- injectsFixtureItemsIntoMatureTray: `True`
- fixtureDefinitionsDontSave: `True`

## Fixture Items

| Item Id | Display | Shape | Cells | Rotation | Tray Visible | devOnly | isEnabled | canDrop | Formal Config | Save Data | Manual Probe |
| --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| `v04_runtime_fixture_single1` | Single1 测试符 | `Single1` | 1 | `False` | `True` | `True` | `False` | `False` | `False` | `False` | 点击后显示单格合法反馈。 |
| `v04_runtime_fixture_vertical2` | Vertical2 测试符 | `Vertical2` | 2 | `True` | `True` | `True` | `False` | `False` | `False` | `False` | 点击后按 R 或旋转按钮测试竖二格旋转。 |
| `v04_runtime_fixture_corner3` | Corner3 测试符 | `Corner3` | 3 | `True` | `True` | `True` | `False` | `False` | `False` | `False` | 点击后测试拐角三格、重叠和越界反馈。 |
| `v04_runtime_fixture_square4` | Square4 测试符 | `Square4` | 4 | `False` | `True` | `True` | `False` | `False` | `False` | `False` | 点击后测试方四格占格预览。 |

## Feedback Targets

| Feedback | Display | Trigger | Expected Chinese Feedback | Required |
| --- | --- | --- | --- | --- |
| `rotation` | 旋转 | Select Vertical2 or Corner3, then press R or click Rotate Shape. | 旋转：90 / 180 / 270。 | `True` |
| `occupancyPreview` | 占格预览 | Hover or drag any fixture over the mature board. | 绿色或红色半透明格显示当前占用。 | `True` |
| `validPlacement` | 合法放置反馈 | Hover a fixture over enough empty in-grid cells. | 可以放置：形状名，占用 N 格。 | `True` |
| `outOfGrid` | 越界反馈 | Hover Vertical2, Corner3, or Square4 near the board edge so one cell leaves the board. | 越界：有格子超出成熟棋盘。 | `True` |
| `overlap` | 重叠 | Hover a fixture over an occupied mature board cell. | 重叠：目标格已有成熟道具。 | `True` |

## Manual Handtest Checklist

- Mature V02 / V03 BattlePrepare page and pull-up hand feel still open through the Manual Only menu.
- The mature tray shows Single1, Vertical2, Corner3, and Square4 devOnly fixture items.
- Selecting a fixture binds the matching V0.4 shape in the extension panel.
- Vertical2 and Corner3 rotate through `R` or the rotate button.
- Hovering or dragging over the mature board shows green valid occupancy and red invalid occupancy.
- Board edge hover reports out-of-grid feedback; occupied-cell hover reports overlap feedback.
- Stopping Play leaves no formal scene, pool, drop, save, or RectTransform changes.
...
| BattlePrepare Component Adapter 01 | `PASS` | 0 | 0 | 17 |
| BattlePrepare Component Adapter Playtest 01 | `PASS` | 0 | 0 | 5 |
| BattlePrepare Component Adapter Runtime Playtest 01 | `PASS` | 0 | 0 | 5 |
| BattlePrepare Runtime Playtest Fixture Feedback Fix 01 | `PASS` | 0 | 0 | 12 |
...
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'RectTransform'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterPlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'RectTransform'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token '.anchoredPosition'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token '.sizeDelta'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token '.anchorMin'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token '.anchorMax'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token '.pivot'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token '.localScale'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'SetParent('. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `FORMAL_UI_CREATION_TOKEN` | BuildSandbox code contains guarded token 'UnityEngine.UI'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `CURRENT_UI_SCENE_TOKEN` | BuildSandbox code contains guarded token 'Scene_TalismanBag_V02_FormationCounter'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
| `Error` | `CURRENT_UI_SCENE_TOKEN` | BuildSandbox code contains guarded token 'V03BattlePrepare'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytest.cs` |
...
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'RectTransform'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/Editor/BuildSandbox/BattlePrepareComponentAdapterPlaytestReportWriter.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'RectTransform'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/Editor/BuildSandbox/BattlePrepareComponentAdapterPlaytestValidator.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'RectTransform'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/Editor/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytestReportWriter.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'RectTransform'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/Editor/BuildSandbox/BattlePrepareComponentAdapterRuntimePlaytestValidator.cs` |
| `Error` | `LAYOUT_WRITE_TOKEN` | BuildSandbox code contains guarded token 'RectTransform'. Keep this package read-only for UI layout. | `Assets/_Game/Scripts/TalismanBag/Editor/BuildSandbox/BattlePrepareRuntimePlaytestFixtureFeedbackReportWriter.cs` |
...
| `Info` | `BATTLE_PREPARE_COMPONENT_ADAPTER_ISOLATION_PASS` | Adapter is devOnly, disabled, and disconnected from formal UI/battle/save surfaces. | `BattlePrepareComponentAdapter` |
| `Info` | `BATTLE_PREPARE_COMPONENT_SECTION_COUNT` | Output section count pass. actual=5, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `BOARD_OCCUPANCY_CELL_COUNT` | Occupied cell count pass. actual=8, expected>=1. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `BOARD_OCCUPANCY_ITEM_COUNT` | Placed item count pass. actual=8, expected>=1. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_TRAY_SHAPE_ITEM_COUNT` | Item tray shape row count pass. actual=8, expected>=1. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_TRAY_SHAPE_CATEGORY_COUNT` | Category label count pass. actual=6, expected>=6. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `DRAG_ROTATION_ROW_COUNT` | Drag/rotation placement row count pass. actual=8, expected>=1. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_INFO_FIELDS_ITEM_COUNT` | Item info row count pass. actual=8, expected>=1. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_INFO_FIELD_COUNT` | Item info field count pass. actual=6, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_INFO_FIELD_COUNT` | Item info field count pass. actual=6, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_INFO_FIELD_COUNT` | Item info field count pass. actual=6, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_INFO_FIELD_COUNT` | Item info field count pass. actual=6, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_INFO_FIELD_COUNT` | Item info field count pass. actual=6, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
...
| `Info` | `ITEM_INFO_FIELD_COUNT` | Item info field count pass. actual=6, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `ITEM_INFO_FIELD_COUNT` | Item info field count pass. actual=6, expected>=5. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `BATTLE_FEEDBACK_ROW_COUNT` | Feedback hint row count pass. actual=5, expected>=1. | `V0.4-BattlePrepareComponentAdapter01` |
| `Info` | `BATTLE_PREPARE_PLAYTEST_ISOLATION_PASS` | Playtest is devOnly, disabled, and disconnected from formal UI/flow/save surfaces. | `BattlePrepareComponentAdapterPlaytestController` |
| `Info` | `BATTLE_PREPARE_PLAYTEST_STATIC_SCOPE_DISCLOSED` | Report-only static hand-feel probe is explicitly disclosed. | `BattlePrepareComponentAdapterPlaytestController` |
| `Info` | `BATTLE_PREPARE_PLAYTEST_PROBE_COUNT` | Probe rows pass. actual=7, expected>=7. | `V0.4-BattlePrepareComponentAdapterPlaytest01` |
| `Info` | `BATTLE_PREPARE_PLAYTEST_PROBES_PASS` | All playtest probes passed. passed=7/7. | `BattlePrepareComponentAdapterPlaytestController` |
| `Info` | `BATTLE_PREPARE_PLAYTEST_MANUAL_CHECK_COUNT` | Manual check rows pass. actual=4, expected>=4. | `V0.4-BattlePrepareComponentAdapterPlaytest01` |
| `Info` | `BATTLE_PREPARE_RUNTIME_PLAYTEST_ISOLATION_PASS` | Runtime playtest is devOnly, manual, disabled by default, and disconnected from formal flow/save/battle surfaces. | `BattlePrepareComponentAdapterRuntimePlaytestPlan` |
| `Info` | `BATTLE_PREPARE_RUNTIME_PLAYTEST_REAL_PATH_DECLARED` | Manual Unity Play path is declared and separated from automated hand-feel claims. | `BattlePrepareComponentAdapterRuntimePlaytestPlan` |
| `Info` | `BATTLE_PREPARE_RUNTIME_PLAYTEST_TARGET_SCENE_FOUND` | Target scene exists: Assets/_Game/Scenes/Scene_TalismanBag_V02_FormationCounter.unity. | `Assets/_Game/Scenes/Scene_TalismanBag_V02_FormationCounter.unity` |
| `Info` | `BATTLE_PREPARE_RUNTIME_PLAYTEST_SURFACE_COUNT` | Runtime surface count pass. actual=7, expected>=6. | `V0.4-BattlePrepareComponentAdapterRuntimePlaytest01` |
| `Info` | `BATTLE_PREPARE_RUNTIME_PLAYTEST_USER_STEP_COUNT` | User handtest step count pass. actual=7, expected>=6. | `V0.4-BattlePrepareComponentAdapterRuntimePlaytest01` |
| `Info` | `BATTLE_PREPARE_FIXTURE_ISOLATION_PASS` | Fixture feedback provider is declared devOnly, DontSave, mature-tray-only, and disconnected from formal pools/save. | `BattlePrepareComponentAdapterRuntimePlaytestPlan` |
| `Info` | `BATTLE_PREPARE_FIXTURE_ITEM_COUNT` | Fixture item count pass. actual=4, expected>=4. | `V0.4-BattlePrepareComponentAdapterRuntimePlaytest01-FixtureFeedbackFix01` |
| `Info` | `BATTLE_PREPARE_FIXTURE_ITEM_REQUIRED_PRESENT` | Required runtime fixture shape present: Single1. | `BattlePrepareRuntimeFixtureItemRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_ITEM_REQUIRED_PRESENT` | Required runtime fixture shape present: Vertical2. | `BattlePrepareRuntimeFixtureItemRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_ITEM_REQUIRED_PRESENT` | Required runtime fixture shape present: Corner3. | `BattlePrepareRuntimeFixtureItemRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_ITEM_REQUIRED_PRESENT` | Required runtime fixture shape present: Square4. | `BattlePrepareRuntimeFixtureItemRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_FEEDBACK_COUNT` | Fixture feedback count pass. actual=5, expected>=5. | `V0.4-BattlePrepareComponentAdapterRuntimePlaytest01-FixtureFeedbackFix01` |
| `Info` | `BATTLE_PREPARE_FIXTURE_FEEDBACK_REQUIRED_PRESENT` | Required runtime feedback target present: rotation. | `BattlePrepareRuntimeFixtureFeedbackRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_FEEDBACK_REQUIRED_PRESENT` | Required runtime feedback target present: occupancyPreview. | `BattlePrepareRuntimeFixtureFeedbackRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_FEEDBACK_REQUIRED_PRESENT` | Required runtime feedback target present: validPlacement. | `BattlePrepareRuntimeFixtureFeedbackRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_FEEDBACK_REQUIRED_PRESENT` | Required runtime feedback target present: outOfGrid. | `BattlePrepareRuntimeFixtureFeedbackRow` |
| `Info` | `BATTLE_PREPARE_FIXTURE_FEEDBACK_REQUIRED_PRESENT` | Required runtime feedback target present: overlap. | `BattlePrepareRuntimeFixtureFeedbackRow` |
