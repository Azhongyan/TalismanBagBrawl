# BuildSandbox Full Pipeline Report
...
| Stage | Input | Output | Isolation |
| --- | --- | --- | --- |
| `BuildSandboxLayoutSnapshot` | `5` shape placed item(s) | occupiedCells populated | devOnly preview only |
| `SynergyEvaluator` | `8` synergy placed item(s) | `3` active synergy result(s) | no formal combat hookup |
| `AffixRarityEvaluator` | `5` affix placed item(s) | `5` item preview result(s) | no drop / wash / reward hookup |
| `ModifierEventBridge` | build + affix preview | `33` modifier(s), `36` event(s) | affectsFormalCombat=false |
| `BuildSimulationBenchmark` | sandbox preview bundles | `4` benchmark result(s) | sandboxEstimate=true |
| `EnemyBossValidationPool` | `11` enemy + `7` boss profile(s) | `18` simulation result(s) | profile entersFormalFlow=false |
| `DevChapterContentPool` | `65` dev chapter profile(s) | `65` simulation result(s) | no formal stage / entrance / reward / drop |
| `LedgerTaskBuildHooks` | sandbox events | `8` goal(s), `123` event(s), `8` progress preview(s) | no formal task list / reward / player progress |

## Active Synergy Output

| synergyId | thresholds | sourceItems | placement | energy |
| --- | --- | --- | --- | --- |
...
| buildId | winRate | clearTime | activeSynergies | devOnly | isEnabled | formalFlow | formalCombat |
| --- | ---: | ---: | --- | --- | --- | --- | --- |
| `sandbox_no_synergy` | 1 | 90 | `` | `True` | `False` | `False` | `False` |
| `sandbox_no_affix` | 0.8119 | 191.34 | `bs_synergy_corruption_ward;bs_synergy_guardian_energy;bs_synergy_lihuo_talisman` | `True` | `False` | `False` | `False` |
| `sandbox_full_preview` | 1 | 90 | `bs_synergy_corruption_ward;bs_synergy_guardian_energy;bs_synergy_lihuo_talisman` | `True` | `False` | `False` | `False` |
| `sandbox_boss_placeholder` | 1 | 90 | `bs_synergy_corruption_ward;bs_synergy_guardian_energy;bs_synergy_lihuo_talisman` | `True` | `False` | `False` | `False` |
