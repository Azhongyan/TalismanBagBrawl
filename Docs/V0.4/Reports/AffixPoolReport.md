...
Status: `PASS`
Data label: `devOnly / disabled / preview pool only / not drop, forge, wash, reward, or numeric config`

## Rarity Tiers

| rarityId | displayName | tierIndex | affixSlots | rollWeight | multiplier | devOnly | isEnabled |
| --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `blue` | Blue Preview | 2 | 3 | 30 | 1.35 | `True` | `False` |
| `green` | Green Preview | 1 | 2 | 60 | 1.15 | `True` | `False` |
| `orange` | Orange Preview | 4 | 5 | 4 | 2.2 | `True` | `False` |
| `purple` | Purple Preview | 3 | 4 | 12 | 1.7 | `True` | `False` |
| `white` | White Preview | 0 | 1 | 100 | 1 | `True` | `False` |

## Affix Configs

| affixId | group | requiredTags | allowedRarities | rollRange | previewToken | devOnly | isEnabled |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
- Seed snapshot items: `5`
- Result items: `5`
- Rarities seen: `blue;green;orange;purple;white`
- Affixes selected: `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_orange_core;bs_affix_purifying_seal`
- Missing requirements: `0`

| itemId | rarity | selectedAffixes | affixSlots | totalPreviewPower | sourceTags |
| --- | --- | --- | ---: | ---: | --- |
