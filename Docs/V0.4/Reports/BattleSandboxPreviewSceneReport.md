# BattleSandbox Preview Scene Report
...
- Independent V0.4 BuildSandbox preview scene skeleton only.
- Creates graybox UI slots for later PreviewContext, data panels, problem selectors, and interaction packages.
- Does not bind formal battle, formal mainline, save, reward, drop, Boss, or numeric systems.
- Does not add the preview scene to Build Settings.

## Scene

- Scene path: `Assets/_Game/Scenes/Scene_TalismanBag_V04_BattleSandboxPreview.unity`
- Scene exists: `True`
- Marker devOnly: `True`
- Marker isEnabled: `False`
- Marker connectedToFormalFlow: `False`
- Hierarchy rows: `84`
...
| --- | --- |
| `EventSystem` | `True` |
| `BuildSandboxPreviewRoot` | `True` |
| `BuildSandboxPreviewCanvas` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BattleLikePreviewArea` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/ProblemSelectorPanel` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BuildSandboxDataPanelDock` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/DevOnlyControlBar` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/PopupLayer` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BattleLikePreviewArea/BoardGridPreview` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BattleLikePreviewArea/ItemTrayPreview` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BattleLikePreviewArea/SelectedItemInfo` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BattleLikePreviewArea/PlacementFeedback` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/ProblemSelectorPanel/MapRuleDropdownSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/ProblemSelectorPanel/EnemyProblemDropdownSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/ProblemSelectorPanel/BossProblemDropdownSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/ProblemSelectorPanel/DevChapterDropdownSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BuildSandboxDataPanelDock/BuildSummaryPanelSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BuildSandboxDataPanelDock/SynergyPanelSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BuildSandboxDataPanelDock/ShapeOccupancyPanelSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BuildSandboxDataPanelDock/AffixModifierPanelSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BuildSandboxDataPanelDock/ProblemReadinessPanelSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/BuildSandboxDataPanelDock/SimulationResultPanelSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/DevOnlyControlBar/RunSimulationButtonSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/DevOnlyControlBar/ResetPreviewButtonSlot` | `True` |
| `BuildSandboxPreviewCanvas/SafeAreaRoot/DevOnlyControlBar/ExportReportButtonSlot` | `True` |
