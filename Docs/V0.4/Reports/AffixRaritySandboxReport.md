# Affix Rarity Sandbox Report

Package: `V0.3/V0.4-BuildSandbox-AffixRaritySandbox01`
Generated: `2026-06-30 22:29:21`
Status: `PASS`

## Scope

- Pure BuildSandbox rarity and affix preview only.
- Input is `BuildSandboxLayoutSnapshot`; output is `AffixRarityEvaluationResult`.
- Rarity scaffold covers white / green / blue / purple / orange.
- Orange-only preview seeds include core affix and bond +1 affix.
- No formal drop, reward, forge, combat modifier, UI, RunFlow, save, boss, or numeric connection.
- Feature flags remain default false; seed configs remain devOnly and disabled.

## Rarity Tiers

| rarityId | tierIndex | affixSlotCount | rollWeight | previewPowerMultiplier | devOnly | isEnabled |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| `blue` | 2 | 3 | 30 | 1.35 | `True` | `False` |
| `green` | 1 | 2 | 60 | 1.15 | `True` | `False` |
| `orange` | 4 | 5 | 4 | 2.2 | `True` | `False` |
| `purple` | 3 | 4 | 12 | 1.7 | `True` | `False` |
| `white` | 0 | 1 | 100 | 1 | `True` | `False` |

## Affix Seeds

| affixId | group | requiredTags | allowedRarities | rollRange | previewResultToken | devOnly | isEnabled |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `bs_affix_bond_plus_one` | `bond_preview` | `bond_preview;synergy_preview` | `orange` | `1-1` | `affix_bond_plus_one_preview` | `True` | `False` |
| `bs_affix_focus_gather` | `energy_preview` | `energy_preview;focus_preview` | `green;blue;purple;orange` | `5-10` | `affix_focus_gather_preview` | `True` | `False` |
| `bs_affix_guardian_ward` | `defense_preview` | `defense_preview;ward_preview` | `green;blue;purple;orange` | `6-12` | `affix_guardian_ward_preview` | `True` | `False` |
| `bs_affix_lihuo_spark` | `damage_preview` | `damage_preview;talisman_preview` | `white;green;blue;purple;orange` | `4-8` | `affix_lihuo_spark_preview` | `True` | `False` |
| `bs_affix_orange_core` | `orange_core_preview` | `orange_core_preview;core_preview` | `orange` | `24-40` | `affix_orange_core_preview` | `True` | `False` |
| `bs_affix_purifying_seal` | `control_preview` | `cleanse_preview;control_preview` | `blue;purple;orange` | `8-16` | `affix_purifying_seal_preview` | `True` | `False` |

## Input Snapshot

| itemId | rarity | affixList | tags | occupiedCells |
| --- | --- | --- | --- | --- |
| `seed_affix_white_damage` | `white` | `bs_affix_lihuo_spark` | `damage_preview;talisman_preview;energy_preview` | `0,0` |
| `seed_affix_green_guardian` | `green` | `bs_affix_guardian_ward;bs_affix_focus_gather` | `defense_preview;ward_preview;energy_preview` | `1,0` |
| `seed_affix_blue_purify` | `blue` | `bs_affix_purifying_seal;bs_affix_focus_gather;bs_affix_guardian_ward` | `cleanse_preview;control_preview;energy_preview;ward_preview` | `3,0` |
| `seed_affix_purple_combo` | `purple` | `bs_affix_purifying_seal;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark` | `damage_preview;defense_preview;energy_preview;control_preview` | `5,0` |
| `seed_affix_orange_core_bond` | `orange` | `bs_affix_orange_core;bs_affix_bond_plus_one;bs_affix_purifying_seal;bs_affix_focus_gather;bs_affix_guardian_ward` | `orange_core_preview;core_preview;bond_preview;synergy_preview;energy_preview;defense_preview;control_preview` | `7,0` |

## Evaluation Result

| itemId | rarity | selectedAffixes | slots | totalPreviewPower | sourceTags |
| --- | --- | --- | ---: | ---: | --- |
| `seed_affix_white_damage` | `white` | `bs_affix_lihuo_spark` | 1 | 6 | `damage_preview;talisman_preview;energy_preview` |
| `seed_affix_green_guardian` | `green` | `bs_affix_focus_gather;bs_affix_guardian_ward` | 2 | 18 | `defense_preview;ward_preview;energy_preview` |
| `seed_affix_blue_purify` | `blue` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_purifying_seal` | 3 | 37 | `cleanse_preview;control_preview;energy_preview;ward_preview` |
| `seed_affix_purple_combo` | `purple` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_purifying_seal` | 4 | 57 | `damage_preview;defense_preview;energy_preview;control_preview` |
| `seed_affix_orange_core_bond` | `orange` | `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_orange_core;bs_affix_purifying_seal` | 5 | 133 | `orange_core_preview;core_preview;bond_preview;synergy_preview;energy_preview;defense_preview;control_preview` |

## Missing Requirements

| itemId | type | requiredId | satisfied | detail |
| --- | --- | --- | --- | --- |
...
- ModifierEventBridge: not implemented in this package.
