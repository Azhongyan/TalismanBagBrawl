# BuildSandbox Preview Context Leak Check Report
...
| `contextIsolationLeaks` | 0 | 0 |
| `selectorOptionLeaks` | 0 | 0 |
| `modifierEventFormalLeaks` | 0 | 0 |
| `simulationRowLeaks` | 0 | 0 |
| `phase2SeedLeaks` | 0 | 0 |

## Formal Scope Confirmation

- UI panel: not created by this package.
- Scene_TalismanBag_V04_BattleSandboxPreview: not written by this package.
- Product V02/V03 scenes: not modified by this package.
- Formal battle, Boss, reward, drop, upgrade, and numeric configs: not connected by this package.
- SaveData, PlayerPrefs, MainTrialProgressData: not read or written by this package.
- PreviewContext output is devOnly, disabled, report/read-model oriented data.
