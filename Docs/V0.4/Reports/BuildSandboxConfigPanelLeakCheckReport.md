# BuildSandbox Config Panel Leak Check Report
...
| `seedIsolationLeaks` | 0 | 0 |
| `dropBiasProductLeaks` | 0 | 0 |
| `panelSourceForbiddenFormalTokenHits` | 0 | 0 |

## Confirmation

- Panel source is under `Assets/_Game/Scripts/TalismanBag/Editor/BuildSandbox/**`.
- Data source is static V0.4 BuildSandbox seed data.
- The panel does not edit `DataCatalogEditorWindow` or `StageConfigPanelEditorUi`.
- The panel does not write V02 / V03 formal data, formal 1-10 / 2-10, UI scenes, save, reward, drop, Boss, or numeric data.
- DropBias remains report-only and does not connect to product drop tables.
