...
Package: `V0.3/V0.4-BuildSandbox-ConfigValidatorReport01`
...
- Editor-only BuildSandbox validation and report export.
- Read-only scan of BuildSandbox configs, seed pools, preview evaluators, and leak guards.
- No automatic config repair, asset deletion, formal flow hookup, UI layout write, save write, reward write, numeric write, or Boss flow write.

## FeatureFlag Status

- Feature flags checked: `8`
- Default false: `8`
- Default true errors: `0`
...
## devOnly / isEnabled Status

- BuildSandbox config assets scanned: `25`
- devOnly=false: `0`
- isEnabled=true: `0`

| Config | devOnly | isEnabled | Asset |
| --- | --- | --- | --- |
| `affix_bond_plus_one_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Affix_BondPlusOne_BuildSandbox.asset` |
| `affix_focused_gather_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Affix_FocusedGather_BuildSandbox.asset` |
| `affix_guardian_ward_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Affix_GuardianWard_BuildSandbox.asset` |
| `affix_lihuo_spark_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Affix_LihuoSpark_BuildSandbox.asset` |
| `affix_orange_core_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Affix_OrangeCore_BuildSandbox.asset` |
| `affix_purifying_seal_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Affix_PurifyingSeal_BuildSandbox.asset` |
| `rarity_blue_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Rarity_Blue_BuildSandbox.asset` |
| `rarity_green_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Rarity_Green_BuildSandbox.asset` |
| `rarity_orange_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Rarity_Orange_BuildSandbox.asset` |
| `rarity_purple_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Rarity_Purple_BuildSandbox.asset` |
| `rarity_white_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/AffixRaritySandbox01/Rarity_White_BuildSandbox.asset` |
| `guard_baseline_01` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/BuildSandboxGuardBaselineConfig.asset` |
| `itemshape_corner3_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/ItemShapeOccupancy01/ItemShape_Corner3_BuildSandbox.asset` |
| `itemshape_single1_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/ItemShapeOccupancy01/ItemShape_Single1_BuildSandbox.asset` |
| `itemshape_square4_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/ItemShapeOccupancy01/ItemShape_Square4_BuildSandbox.asset` |
| `itemshape_vertical2_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/ItemShapeOccupancy01/ItemShape_Vertical2_BuildSandbox.asset` |
| `archetype_lihuo_engine_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/Archetype_LihuoEngine_BuildSandbox.asset` |
| `archetype_ward_control_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/Archetype_WardControl_BuildSandbox.asset` |
| `itemtag_fire_talisman_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/ItemTag_FireTalisman_BuildSandbox.asset` |
| `itemtag_guardian_focus_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/ItemTag_GuardianFocus_BuildSandbox.asset` |
| `itemtag_soul_furnace_residue_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/ItemTag_SoulFurnaceResidue_BuildSandbox.asset` |
| `itemtag_thunder_sword_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/ItemTag_ThunderSword_BuildSandbox.asset` |
| `synergy_corruption_ward_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/Synergy_CorruptionWard_BuildSandbox.asset` |
| `synergy_guardian_energy_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/Synergy_GuardianEnergy_BuildSandbox.asset` |
| `synergy_lihuo_talisman_buildsandbox` | `True` | `False` | `Assets/_Game/Configs/BuildSandbox/SynergyDataFoundation01/Synergy_LihuoTalisman_BuildSandbox.asset` |
...
## Formal Flow Leak Check

- FeatureFlag default true: expected `0`.
- devOnly=false BuildSandbox configs: expected `0`.
- isEnabled=true BuildSandbox configs: expected `0`.
- DevChapter / Ledger / EnemyBoss leak counters are consolidated in `BuildSandboxLeakCheckReport.md`.
