# BattleSandbox Enemy Encounter Preview Report

Package: `V0.4-BattleSandboxEnemyEncounterPreview01`
Generated: `2026-07-03 08:40:26`
Status: `PASS`
Errors: `0`
Warnings: `0`
Leak Count: `0`
...
- Adds only a V04 BuildSandbox/devOnly enemy and Boss encounter preview.
- Target scene: `Assets/_Game/Scenes/Scene_TalismanBag_V04_BattleSandboxPreview.unity`.
- Player-facing copy shows Chinese hints for map mechanics, enemy pressure, Boss skills, weakness windows, readiness, failure feedback, and drop-bias atmosphere.
- hardSolutionTags, requiredSynergy, requiredAffix, requiredStats, drop-bias weights, and Boss six-key full answers remain masked in developer data links.
- Formal RunFlow, formal combat damage, rewards, save/progress data, formal Boss/enemy config, and formal 3-10 / 4-10 are not connected.

## Required Counters

- devOnly enemy count: `11`
- devOnly Boss count: `7`
- displayed hint count: `144`
...
| Encounter | Kind | Selector | Test Target | Weakness | Readiness |
| --- | --- | --- | --- | --- | --- |
| `dev_enemy_basic` | `enemy` | 敌人：普通怪 | 测试目标：护盾 / 破盾。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_shield_guard` | `enemy` | 敌人：护盾怪 | 测试目标：护盾 / 破盾。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_poison_cultist` | `enemy` | 敌人：毒怪 | 测试目标：负面 / 污染。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_burning_wisp` | `enemy` | 敌人：燃烧怪 | 测试目标：负面 / 污染、群怪清场。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_spirit_thief` | `enemy` | 敌人：偷灵怪 | 测试目标：供能干扰。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_seal_locker` | `enemy` | 敌人：封符怪 | 测试目标：控制 / 打断。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_swarm_pack` | `enemy` | 敌人：群怪 | 测试目标：群怪清场。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_burst_assassin` | `enemy` | 敌人：高爆发怪 | 测试目标：爆发承压、群怪清场。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_caster_chanter` | `enemy` | 敌人：施法怪 | 测试目标：控制 / 打断。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_thick_blood` | `enemy` | 敌人：厚血怪 | 测试目标：长线输出、控制 / 打断。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_enemy_formation_eye_jammer` | `enemy` | 敌人：阵眼干扰怪 | 测试目标：阵眼 / 摆放、供能干扰。 | 若敌人露出破绽，只提示短暂窗口与战斗反馈，不显示触发公式。 | 准备度预览只告诉你当前构筑是否覆盖这类压力；完整答案留在开发者数据面板。 |
| `dev_boss_shield_jinglei` | `boss` | 首领：护盾首领：验证惊雷 | 测试目标：护盾 / 破盾。 | 弱点窗口：连续破三层护壳 -> 首领 虚弱。只提示时机，不显示完整答案。 | 准备度预览只显示是否大致够用；钥匙、数值和完整答案留在开发者数据面板。 |

## Developer Answer Links

| English Stable Key | Chinese Display Name | Data Panel Slot | Source | Player Visible | Masked From Player |
| --- | --- | --- | --- | --- | --- |
| `hardSolutionTags` | 硬解标签 | `ProblemReadinessPanelSlot` | `BuildProblemSeedDataset.enemyProblems.hardSolutionTags` | `False` | `True` |
| `requiredSynergy` | 必需协同 | `ProblemReadinessPanelSlot` | `BuildProblemSeedDataset.bossProblems.keyRequirements` | `False` | `True` |
| `requiredAffix` | 必需词缀 | `ProblemReadinessPanelSlot` | `BuildProblemSeedDataset.bossProblems.keyRequirements` | `False` | `True` |
| `requiredStats` | 必需属性 | `ProblemReadinessPanelSlot` | `BuildProblemSeedDataset.bossProblems.requiredProblemAttributes` | `False` | `True` |
| `dropBiasWeights` | 定向倾向权重 | `ProblemReadinessPanelSlot` | `BuildProblemSeedDataset.dropBiases.previewWeight` | `False` | `True` |
| `bossSixKeyFullAnswer` | Boss六钥匙完整答案 | `ProblemReadinessPanelSlot` | `BuildProblemSeedDataset.bossProblems.keyRequirements` | `False` | `True` |
...
| BattleSandbox Preview Scene 01 | `PASS` | 0 | 0 | 43 |
| Build Tuning Data Panel Preview 01 | `PASS` | 0 | 0 | 5 |
| Mechanic Hint Feedback Preview 01 | `PASS` | 0 | 0 | 23 |
| BattleSandbox Enemy Encounter Preview 01 | `PASS` | 0 | 0 | 32 |
...
| `Info` | `BATTLE_SANDBOX_CHILD_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel` |
...
| `Info` | `BATTLE_SANDBOX_CHILD_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel` |
...
| `Info` | `ENCOUNTER_PREVIEW_ENABLED_TRUE` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_RUNS_FORMAL_COMBAT` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_WRITES_FORMAL_FLOW` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_WRITES_SAVE` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_GRANTS_REWARD` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_READS_ENEMY_DEFINITION` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_READS_BOSS_CONFIG` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_CHANGES_DAMAGE` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_SHOWS_FULL_ANSWERS` | Isolation flag remains false. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_ISOLATION_PASS` | Preview is devOnly, disabled, and disconnected from formal flow/combat/reward/save data. | `BattleSandboxEnemyEncounterPreview` |
| `Info` | `ENCOUNTER_PREVIEW_ENEMY_COUNT` | devOnly enemy option count pass. actual=11, expected>=11. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_BOSS_COUNT` | devOnly boss option count pass. actual=7, expected>=7. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_DISPLAYED_HINT_COUNT` | Displayed player hint count pass. actual=144, expected>=70. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_MASKED_FIELD_COUNT` | Masked answer field count pass. actual=6, expected>=6. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_ROW_COUNT` | Encounter preview row count pass. actual=18, expected>=18. | `V0.4-BattleSandboxEnemyEncounterPreview01` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/EnemySelector | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/EnemySelector` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/PreviousEnemyButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/PreviousEnemyButton` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/NextEnemyButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/NextEnemyButton` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/PreviousBossButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/PreviousBossButton` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/NextBossButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/NextBossButton` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/ReadinessPreviewButton | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/ProblemSelectorPanel/EnemyEncounterSelectorPanel/ReadinessPreviewButton` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/EnemyInfoBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/EnemyInfoBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/MechanicHintBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/MechanicHintBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/WeaknessWindowBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/WeaknessWindowBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/ReadinessPreviewBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/ReadinessPreviewBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/FailureFeedbackBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/FailureFeedbackBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/DropBiasHintBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/DropBiasHintBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/TestTargetBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/TestTargetBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/FormalIsolationBlock | `BuildSandboxPreviewCanvas/MobileSafeAreaRoot/SafeAreaRoot/BuildSandboxDataPanelDock/EnemyEncounterPreviewPanel/FormalIsolationBlock` |
| `Info` | `ENCOUNTER_PREVIEW_SCENE_OBJECT_PRESENT` | BuildSandboxPreviewRoot/EnemyEncounterPreviewRuntime | `BuildSandboxPreviewRoot/EnemyEncounterPreviewRuntime` |
