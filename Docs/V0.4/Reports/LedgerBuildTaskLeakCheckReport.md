# Ledger Build Task Leak Check Report
...
| `nonDevOnlyGoals` | 0 | 0 |
| `formalTaskGoals` | 0 | 0 |
| `formalRewardGoals` | 0 | 0 |
| `playerProgressReads` | 0 | 0 |
| `formalEventLeaks` | 0 | 0 |
| `formalProgressLeaks` | 0 | 0 |

## Per Goal Flags

| taskGoalId | devOnly | isEnabled | entersFormalFlow | grantsFormalReward | entersFormalTaskList | readsFormalPlayerProgress |
| --- | --- | --- | --- | --- | --- | --- |
| `ledger_goal_activate_synergy_2` | `True` | `False` | `False` | `False` | `False` | `False` |
| `ledger_goal_activate_synergy_4` | `True` | `False` | `False` | `False` | `False` | `False` |
| `ledger_goal_activate_synergy_6` | `True` | `False` | `False` | `False` | `False` | `False` |
| `ledger_goal_thunder_defeat_shield_boss` | `True` | `False` | `False` | `False` | `False` | `False` |
| `ledger_goal_cleanse_negative_status` | `True` | `False` | `False` | `False` | `False` | `False` |
| `ledger_goal_complete_specified_build_validation` | `True` | `False` | `False` | `False` | `False` | `False` |
| `ledger_goal_obtain_orange_core_affix` | `True` | `False` | `False` | `False` | `False` | `False` |
| `ledger_goal_complete_affix_reroll` | `True` | `False` | `False` | `False` | `False` | `False` |
