# BuildSandbox Guard Baseline Report

Package: `V0.3/V0.4-BuildSandbox-GuardBaseline01`
...
- devOnly configs stay devOnly=true and isEnabled=false.
- Config validation is Editor-only and read-only.
- UI Layout Guard scans BuildSandbox code and does not write scenes.
- CoreFlow Smoke is a placeholder entry and does not enter product flow.
...
- Current UI scenes / RectTransform / hand-tuned layout: not modified by this package.
- RunFlow / PageState / FormationState: not modified by this package.
- SaveData / PlayerPrefs / MainTrialProgressData: not modified by this package.
- Boss / rewards / drops / numeric configs: not modified by this package.
- FeatureFlag default true: none.
- devOnly=false BuildSandbox configs: none when status is PASS.
