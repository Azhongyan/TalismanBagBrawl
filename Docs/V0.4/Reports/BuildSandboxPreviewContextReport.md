# BuildSandbox Preview Context Report

Package: `V0.4-BuildSandboxPreviewContext01`
Generated: `2026-07-01 11:29:18`
Status: `PASS`
Errors: `0`
Warnings: `0`
...
- Builds a devOnly, disabled, read-only PreviewContext for later UI panel work.
- Aggregates Phase 1 BuildSandbox engine outputs and Phase 2 problem seed data.
- Does not create UI, write scenes, enter formal combat, read formal persistence, or write formal data.

## Context

- previewBuildId: `buildsandbox_preview_context`
- devOnly: `True`
- isEnabled: `False`
...
- featureFlagsAllDisabled: `True`

## Output Sections

| Section | Primary Count | Status |
| --- | ---: | --- |
| Build Summary | 8 placed / 8 cells | `PASS` |
| Synergy | 3 active / 6 thresholds | `PASS` |
| Shape Occupancy | 5 valid samples / 4 invalid QA samples | `PASS` |
| Affix Modifier | 33 modifiers / 36 events | `PASS` |
| Problem Selector | 26 options | `PASS` |
| Problem Readiness | 6 boss rows / 25 keys | `PASS` |
| Simulation Result | 4 results / 3 comparisons | `PASS` |
