# Build Simulation Benchmark Report

Package: `V0.3/V0.4-BuildSandbox-BuildSimulationBenchmark01`
Generated: `2026-06-30 22:29:21`
Status: `PASS`
Data label: `sandbox estimate / devOnly / disabled`

## Scope

- Pure BuildSandbox batch simulation and benchmark reporting.
- Uses `BuildSandboxLayoutSnapshot`, `SynergyEvaluator`, Affix preview, `CombatModifierBundle` preview, and `EffectEventBundle` preview.
- Enemy and Boss inputs are devOnly placeholder tags, not formal enemy/Boss pools.
- No formal combat, UI, RunFlow, PageState, FormationState, save, reward, boss, drop, or numeric config connection.
- Every scenario and result remains `devOnly=true`, `isEnabled=false`, and `sandboxEstimate=true`.

## Scenario Inputs

| Build | Enemy Type | Boss Mechanic | Item Rarity | Affixes | Energy | Placement | devOnly | isEnabled |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `sandbox_no_synergy` | `devOnly_training_dummy` | `none` | `mixed_preview` | `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_orange_core;bs_affix_purifying_seal` | `powered_sample` | `sample_layout_no_synergy` | `True` | `False` |
| `sandbox_no_affix` | `devOnly_training_dummy` | `none` | `none` | `` | `powered_sample` | `sample_layout_no_affix` | `True` | `False` |
| `sandbox_full_preview` | `devOnly_training_dummy` | `none` | `mixed_preview` | `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_orange_core;bs_affix_purifying_seal` | `powered_sample` | `sample_adjacency_and_energy` | `True` | `False` |
| `sandbox_boss_placeholder` | `devOnly_boss_shell` | `devOnly_shield_phase_placeholder` | `orange_focus_preview` | `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_orange_core;bs_affix_purifying_seal` | `powered_sample` | `boss_placeholder_layout` | `True` | `False` |

## Simulation Results

| Build | Active Synergies | Synergy Level | Clear Time (sandbox estimate sec) | Win Rate (sandbox estimate) | Remaining HP (sandbox estimate) | Total Damage (sandbox estimate) | Shield Break Efficiency | Energy Coverage | Triggered Events | Failure Reason | Numeric Anomaly |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `sandbox_no_synergy` | `` | 0 | 90 | 1 | 0.7658 | 5099.35 | 0.3896 | 0.75 | 24 | `none` | `False` |
| `sandbox_no_affix` | `bs_synergy_corruption_ward;bs_synergy_guardian_energy;bs_synergy_lihuo_talisman` | 6 | 191.34 | 0.8119 | 0.5385 | 2167 | 0.3738 | 0.75 | 12 | `none` | `False` |
| `sandbox_full_preview` | `bs_synergy_corruption_ward;bs_synergy_guardian_energy;bs_synergy_lihuo_talisman` | 6 | 90 | 1 | 0.7658 | 6416.35 | 0.5834 | 0.75 | 36 | `none` | `False` |
| `sandbox_boss_placeholder` | `bs_synergy_corruption_ward;bs_synergy_guardian_energy;bs_synergy_lihuo_talisman` | 6 | 90 | 1 | 0.7658 | 6416.35 | 0.5834 | 0.75 | 36 | `none` | `False` |

## Comparisons

| Comparison | Baseline | Challenger | Dimension | Clear Time Delta | Win Rate Delta | Remaining HP Delta | Total Damage Delta | Shield Break Delta | Event Delta |
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `with_vs_without_synergy` | `sandbox_no_synergy` | `sandbox_full_preview` | `synergy` | 0 | 0 | 0 | 1317 | 0.1938 | 12 |
| `with_vs_without_affix` | `sandbox_no_affix` | `sandbox_full_preview` | `affix` | -101.34 | 0.1881 | 0.2273 | 4249.35 | 0.2096 | 24 |
| `training_vs_boss_placeholder` | `sandbox_full_preview` | `sandbox_boss_placeholder` | `boss placeholder` | 0 | 0 | 0 | 0 | 0 | 0 |

## Preview Usage

| Build | Modifier Preview Used | Event Preview Used | Affects Formal Combat |
| --- | --- | --- | --- |
| `sandbox_no_synergy` | `True` | `True` | `False` |
| `sandbox_no_affix` | `True` | `True` | `False` |
| `sandbox_full_preview` | `True` | `True` | `False` |
| `sandbox_boss_placeholder` | `True` | `True` | `False` |
...
- Formal combat connection: not touched; all benchmark values are `sandbox estimate`.
- Formal player save / PlayerPrefs / MainTrialProgressData: not read.
...
- FeatureFlag default true: none when this report is PASS.

## User Check

- Confirm the reports are marked sandbox / devOnly.
- Confirm FeatureFlags remain false.
- Confirm current UI hand tune and formal battle are not connected to this benchmark.
