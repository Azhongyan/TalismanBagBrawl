# Modifier Event Bridge Report

Package: `V0.3/V0.4-BuildSandbox-ModifierEventBridge01`
Generated: `2026-06-30 22:29:21`
Status: `PASS`

## Scope

- Pure BuildSandbox bridge preview only.
- Inputs are `BuildEvaluationResult` and `AffixRarityEvaluationResult`.
- Outputs are `CombatModifierBundle` and `EffectEventBundle` preview data.
- No formal combat, UI, RunFlow, PageState, FormationState, save, reward, boss, or numeric connection.
- Feature flags remain default false; preview outputs remain devOnly and disabled.

## Input BuildEvaluationResult Summary
...
## Active Synergy Inputs

| synergyId | activeThresholds | sourceItems | placementSatisfied | energySatisfied |
| --- | --- | --- | --- | --- |
| `bs_synergy_corruption_ward` | `bs_synergy_corruption_ward:2` | `seed_corruption_1;seed_corruption_2` | `True` | `True` |
| `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:2;bs_synergy_guardian_energy:4;bs_synergy_guardian_energy:6` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `True` | `True` |
| `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:2;bs_synergy_lihuo_talisman:4` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `True` | `True` |

## Affix Preview Input Summary

- itemResults: `5`
- rarityIds: `blue;green;orange;purple;white`
- affixIds: `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_orange_core;bs_affix_purifying_seal`
- missingRequirements: `0`

## Affix Item Inputs

| itemId | rarity | selectedAffixes | totalPreviewPower | sourceTags |
| --- | --- | --- | ---: | --- |
| `seed_affix_white_damage` | `white` | `bs_affix_lihuo_spark` | 6 | `damage_preview;talisman_preview;energy_preview` |
| `seed_affix_green_guardian` | `green` | `bs_affix_focus_gather;bs_affix_guardian_ward` | 18 | `defense_preview;ward_preview;energy_preview` |
| `seed_affix_blue_purify` | `blue` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_purifying_seal` | 37 | `cleanse_preview;control_preview;energy_preview;ward_preview` |
| `seed_affix_purple_combo` | `purple` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_purifying_seal` | 57 | `damage_preview;defense_preview;energy_preview;control_preview` |
| `seed_affix_orange_core_bond` | `orange` | `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_orange_core;bs_affix_purifying_seal` | 133 | `orange_core_preview;core_preview;bond_preview;synergy_preview;energy_preview;defense_preview;control_preview` |

## Reserved Modifier Types

| modifierType | supported | generatedInSample |
| --- | --- | --- |
| `damageBonus` | `true` | `True` |
| `cooldownBonus` | `true` | `True` |
| `shieldBreakBonus` | `true` | `True` |
| `shieldBonus` | `true` | `True` |
| `cleanseBonus` | `true` | `True` |
| `controlDurationBonus` | `true` | `True` |
| `energyReturnBonus` | `true` | `True` |

## Reserved Event Types

| eventType | supported | generatedInSample |
| --- | --- | --- |
| `onBattleStart` | `true` | `True` |
| `onShieldBreak` | `true` | `True` |
| `onCleanse` | `true` | `True` |
| `onShieldBroken` | `true` | `True` |
| `onEnemyKill` | `true` | `True` |
| `onBossSkillCast` | `true` | `True` |
| `onLowHp` | `true` | `True` |
| `onEnergyConnected` | `true` | `True` |

## CombatModifierBundle Preview

- sourceBuildId: `seed_modifier_event_bridge`
- devOnly: `True`
- isEnabled: `False`
- affectsFormalCombat: `False`
- modifiers: `33`

| modifierType | previewValue | sourceSynergy | sourceThreshold | sourceAffix | sourceItem | affectsFormalCombat |
| --- | ---: | --- | --- | --- | --- | --- |
| `damageBonus` | 0.1 | `bs_synergy_corruption_ward` | `bs_synergy_corruption_ward:2` | `` | `seed_corruption_1;seed_corruption_2` | `False` |
| `shieldBreakBonus` | 0.08 | `bs_synergy_corruption_ward` | `bs_synergy_corruption_ward:2` | `` | `seed_corruption_1;seed_corruption_2` | `False` |
| `energyReturnBonus` | 0.06 | `bs_synergy_corruption_ward` | `bs_synergy_corruption_ward:2` | `` | `seed_corruption_1;seed_corruption_2` | `False` |
| `damageBonus` | 0.1 | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:2` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `damageBonus` | 0.2 | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:4` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `cooldownBonus` | 0.1 | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:4` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `damageBonus` | 0.3 | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:6` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `cooldownBonus` | 0.15 | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:6` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `shieldBreakBonus` | 0.08 | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:2;bs_synergy_guardian_energy:4;bs_synergy_guardian_energy:6` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `energyReturnBonus` | 0.06 | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:2;bs_synergy_guardian_energy:4;bs_synergy_guardian_energy:6` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `damageBonus` | 0.1 | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:2` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `damageBonus` | 0.2 | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:4` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `cooldownBonus` | 0.1 | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:4` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `shieldBreakBonus` | 0.08 | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:2;bs_synergy_lihuo_talisman:4` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `energyReturnBonus` | 0.06 | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:2;bs_synergy_lihuo_talisman:4` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `damageBonus` | 0.06 | `` | `` | `bs_affix_lihuo_spark` | `seed_affix_white_damage` | `False` |
| `energyReturnBonus` | 0.18 | `` | `` | `bs_affix_focus_gather` | `seed_affix_green_guardian` | `False` |
| `shieldBonus` | 0.18 | `` | `` | `bs_affix_guardian_ward` | `seed_affix_green_guardian` | `False` |
| `energyReturnBonus` | 0.37 | `` | `` | `bs_affix_focus_gather` | `seed_affix_blue_purify` | `False` |
| `shieldBonus` | 0.37 | `` | `` | `bs_affix_guardian_ward` | `seed_affix_blue_purify` | `False` |
| `cleanseBonus` | 0.37 | `` | `` | `bs_affix_purifying_seal` | `seed_affix_blue_purify` | `False` |
| `controlDurationBonus` | 0.185 | `` | `` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_purifying_seal` | `seed_affix_blue_purify` | `False` |
| `energyReturnBonus` | 0.57 | `` | `` | `bs_affix_focus_gather` | `seed_affix_purple_combo` | `False` |
| `shieldBonus` | 0.57 | `` | `` | `bs_affix_guardian_ward` | `seed_affix_purple_combo` | `False` |
| `damageBonus` | 0.57 | `` | `` | `bs_affix_lihuo_spark` | `seed_affix_purple_combo` | `False` |
| `cleanseBonus` | 0.57 | `` | `` | `bs_affix_purifying_seal` | `seed_affix_purple_combo` | `False` |
| `controlDurationBonus` | 0.285 | `` | `` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_purifying_seal` | `seed_affix_purple_combo` | `False` |
| `cooldownBonus` | 1.33 | `` | `` | `bs_affix_bond_plus_one` | `seed_affix_orange_core_bond` | `False` |
| `energyReturnBonus` | 1.33 | `` | `` | `bs_affix_focus_gather` | `seed_affix_orange_core_bond` | `False` |
| `shieldBonus` | 1.33 | `` | `` | `bs_affix_guardian_ward` | `seed_affix_orange_core_bond` | `False` |
| `shieldBreakBonus` | 1.33 | `` | `` | `bs_affix_orange_core` | `seed_affix_orange_core_bond` | `False` |
| `cleanseBonus` | 1.33 | `` | `` | `bs_affix_purifying_seal` | `seed_affix_orange_core_bond` | `False` |
| `controlDurationBonus` | 0.665 | `` | `` | `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_orange_core;bs_affix_purifying_seal` | `seed_affix_orange_core_bond` | `False` |
...
| eventType | trigger | sourceSynergy | sourceThreshold | sourceAffix | sourceItem | affectsFormalCombat |
| --- | --- | --- | --- | --- | --- | --- |
| `onBattleStart` | `onBattleStart` | `bs_synergy_corruption_ward` | `bs_synergy_corruption_ward:2` | `` | `seed_corruption_1;seed_corruption_2` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `bs_synergy_corruption_ward` | `bs_synergy_corruption_ward:2` | `` | `seed_corruption_1;seed_corruption_2` | `False` |
| `onBattleStart` | `onBattleStart` | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:2` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onBattleStart` | `onBattleStart` | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:4` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onShieldBreak` | `onShieldBreak` | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:4` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onBattleStart` | `onBattleStart` | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:6` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onShieldBreak` | `onShieldBreak` | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:6` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `bs_synergy_guardian_energy` | `bs_synergy_guardian_energy:2;bs_synergy_guardian_energy:4;bs_synergy_guardian_energy:6` | `` | `seed_guardian_1;seed_guardian_2;seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onBattleStart` | `onBattleStart` | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:2` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onBattleStart` | `onBattleStart` | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:4` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onShieldBreak` | `onShieldBreak` | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:4` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `bs_synergy_lihuo_talisman` | `bs_synergy_lihuo_talisman:2;bs_synergy_lihuo_talisman:4` | `` | `seed_lihuo_1;seed_lihuo_2;seed_lihuo_3;seed_lihuo_4` | `False` |
| `onShieldBreak` | `onShieldBreak` | `` | `` | `bs_affix_lihuo_spark` | `seed_affix_white_damage` | `False` |
| `onEnemyKill` | `onEnemyKill` | `` | `` | `bs_affix_lihuo_spark` | `seed_affix_white_damage` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `` | `` | `bs_affix_focus_gather` | `seed_affix_green_guardian` | `False` |
| `onShieldBroken` | `onShieldBroken` | `` | `` | `bs_affix_guardian_ward` | `seed_affix_green_guardian` | `False` |
| `onLowHp` | `onLowHp` | `` | `` | `bs_affix_focus_gather;bs_affix_guardian_ward` | `seed_affix_green_guardian` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `` | `` | `bs_affix_focus_gather` | `seed_affix_blue_purify` | `False` |
| `onShieldBroken` | `onShieldBroken` | `` | `` | `bs_affix_guardian_ward` | `seed_affix_blue_purify` | `False` |
| `onCleanse` | `onCleanse` | `` | `` | `bs_affix_purifying_seal` | `seed_affix_blue_purify` | `False` |
| `onLowHp` | `onLowHp` | `` | `` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_purifying_seal` | `seed_affix_blue_purify` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `` | `` | `bs_affix_focus_gather` | `seed_affix_purple_combo` | `False` |
| `onEnemyKill` | `onEnemyKill` | `` | `` | `bs_affix_focus_gather` | `seed_affix_purple_combo` | `False` |
| `onShieldBroken` | `onShieldBroken` | `` | `` | `bs_affix_guardian_ward` | `seed_affix_purple_combo` | `False` |
| `onEnemyKill` | `onEnemyKill` | `` | `` | `bs_affix_guardian_ward` | `seed_affix_purple_combo` | `False` |
| `onShieldBreak` | `onShieldBreak` | `` | `` | `bs_affix_lihuo_spark` | `seed_affix_purple_combo` | `False` |
| `onEnemyKill` | `onEnemyKill` | `` | `` | `bs_affix_lihuo_spark` | `seed_affix_purple_combo` | `False` |
| `onCleanse` | `onCleanse` | `` | `` | `bs_affix_purifying_seal` | `seed_affix_purple_combo` | `False` |
| `onEnemyKill` | `onEnemyKill` | `` | `` | `bs_affix_purifying_seal` | `seed_affix_purple_combo` | `False` |
| `onLowHp` | `onLowHp` | `` | `` | `bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_lihuo_spark;bs_affix_purifying_seal` | `seed_affix_purple_combo` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `` | `` | `bs_affix_bond_plus_one` | `seed_affix_orange_core_bond` | `False` |
| `onEnergyConnected` | `onEnergyConnected` | `` | `` | `bs_affix_focus_gather` | `seed_affix_orange_core_bond` | `False` |
| `onShieldBroken` | `onShieldBroken` | `` | `` | `bs_affix_guardian_ward` | `seed_affix_orange_core_bond` | `False` |
| `onBossSkillCast` | `onBossSkillCast` | `` | `` | `bs_affix_orange_core` | `seed_affix_orange_core_bond` | `False` |
| `onCleanse` | `onCleanse` | `` | `` | `bs_affix_purifying_seal` | `seed_affix_orange_core_bond` | `False` |
| `onLowHp` | `onLowHp` | `` | `` | `bs_affix_bond_plus_one;bs_affix_focus_gather;bs_affix_guardian_ward;bs_affix_orange_core;bs_affix_purifying_seal` | `seed_affix_orange_core_bond` | `False` |
...
- Formal combat connection: not touched; `affectsFormalCombat=false` on every preview output.
- Current UI scene / RectTransform / hand-tuned layout: not touched.
- RunFlow / PageState / FormationState / V02RunFlowController / V02FormationGridFrame / DamageText: not touched.
- SaveData / PlayerPrefs / MainTrialProgressData: not touched.
- Boss / rewards / drops / numeric configs: not touched.
- BuildSimulationBenchmark batch simulator: not implemented in this package.
