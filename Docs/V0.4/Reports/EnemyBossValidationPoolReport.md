# Enemy/Boss Validation Pool Report

Package: `V0.3/V0.4-BuildSandbox-EnemyBossValidationPool01`
Generated: `2026-06-30 22:29:21`
Status: `PASS`
Data label: `devOnly / disabled / simulator readable / not formal flow`

## Scope

- Dev-only enemy and Boss validation profiles for BuildSimulationBenchmark sandbox reads.
- No formal 1-10 / 2-10, formal enemy pool, formal Boss config, reward, drop, numeric, save, UI, RunFlow, PageState, FormationState, DamageText, or V02FormationGridFrame connection.
- Every profile remains `devOnly=true`, `isEnabled=false`, `simulatorReadable=true`, and `entersFormalFlow=false`.

## Enemy Profiles

| enemyId | 中文定位 | 验证目标 Build | 验证标签 | 推荐羁绊 | devOnly | isEnabled | 进入正式流程 | 模拟器可读取 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dev_enemy_basic` | 普通怪 | `baseline_build` | `basic;baseline` | 惊雷;离火 | `True` | `False` | `False` | `True` |
| `dev_enemy_shield_guard` | 护盾怪 | `jing_lei_break;hu_zhen_guard` | `shield;break_test` | 惊雷;护阵 | `True` | `False` | `False` | `True` |
| `dev_enemy_poison_cultist` | 毒怪 | `jing_e_cleanse` | `poison;negative_status` | 净厄 | `True` | `False` | `False` | `True` |
| `dev_enemy_burning_wisp` | 燃烧怪 | `li_huo_damage` | `burning;dot_pressure` | 离火;净厄 | `True` | `False` | `False` | `True` |
| `dev_enemy_spirit_thief` | 偷灵怪 | `ju_neng_energy` | `energy_drain;resource_disrupt` | 聚能 | `True` | `False` | `False` | `True` |
| `dev_enemy_seal_locker` | 封符怪 | `zhen_hun_control;jing_e_cleanse` | `seal_lock;control` | 镇魂;净厄 | `True` | `False` | `False` | `True` |
| `dev_enemy_swarm_pack` | 群怪 | `li_huo_aoe` | `swarm;multi_target` | 离火 | `True` | `False` | `False` | `True` |
| `dev_enemy_burst_assassin` | 高爆发怪 | `hu_zhen_survive` | `burst;low_hp_pressure` | 护阵 | `True` | `False` | `False` | `True` |
| `dev_enemy_caster_chanter` | 施法怪 | `zhen_hun_interrupt` | `caster;skill_cast` | 镇魂 | `True` | `False` | `False` | `True` |
| `dev_enemy_thick_blood` | 厚血怪 | `li_huo_damage;jing_lei_break` | `high_hp;long_fight` | 离火;惊雷 | `True` | `False` | `False` | `True` |
| `dev_enemy_formation_eye_jammer` | 阵眼干扰怪 | `ju_neng_energy;hu_zhen_guard` | `formation_eye;placement_disrupt` | 聚能;护阵 | `True` | `False` | `False` | `True` |

## Boss Profiles

| bossId | 中文定位 | 验证目标 Build | 验证标签 | 推荐羁绊 | devOnly | isEnabled | 进入正式流程 | 模拟器可读取 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dev_boss_shield_jinglei` | 护盾Boss：验证惊雷 | `jing_lei_break` | `shield;boss;break_test` | 惊雷 | `True` | `False` | `False` | `True` |
| `dev_boss_swarm_lihuo` | 群怪Boss：验证离火 | `li_huo_aoe` | `swarm;boss;multi_target` | 离火 | `True` | `False` | `False` | `True` |
| `dev_boss_burst_huzhen` | 高爆发Boss：验证护阵 | `hu_zhen_survive` | `burst;boss;low_hp_pressure` | 护阵 | `True` | `False` | `False` | `True` |
| `dev_boss_debuff_jinge` | 负面状态Boss：验证净厄 | `jing_e_cleanse` | `negative_status;boss;cleanse` | 净厄 | `True` | `False` | `False` | `True` |
| `dev_boss_caster_zhenhun` | 施法Boss：验证镇魂 | `zhen_hun_control` | `caster;boss;skill_cast` | 镇魂 | `True` | `False` | `False` | `True` |
| `dev_boss_energy_juneng` | 供能干扰Boss：验证聚能 | `ju_neng_energy` | `energy_drain;boss;resource_disrupt` | 聚能 | `True` | `False` | `False` | `True` |
| `dev_boss_hybrid_combo` | 混合机制Boss：验证组合Build | `combo_build` | `hybrid;boss;combo` | 惊雷;离火;护阵;净厄;镇魂;聚能 | `True` | `False` | `False` | `True` |

## Simulator Read Check

| Scenario | enemyId | bossId | 中文定位 | Win Rate Estimate | Clear Time Estimate | Formal Flow | Simulator Readable |
| --- | --- | --- | --- | ---: | ---: | --- | --- |
| `pool_enemy_dev_enemy_basic` | `dev_enemy_basic` | `` | 普通怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_shield_guard` | `dev_enemy_shield_guard` | `` | 护盾怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_poison_cultist` | `dev_enemy_poison_cultist` | `` | 毒怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_burning_wisp` | `dev_enemy_burning_wisp` | `` | 燃烧怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_spirit_thief` | `dev_enemy_spirit_thief` | `` | 偷灵怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_seal_locker` | `dev_enemy_seal_locker` | `` | 封符怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_swarm_pack` | `dev_enemy_swarm_pack` | `` | 群怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_burst_assassin` | `dev_enemy_burst_assassin` | `` | 高爆发怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_caster_chanter` | `dev_enemy_caster_chanter` | `` | 施法怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_thick_blood` | `dev_enemy_thick_blood` | `` | 厚血怪 | 1 | 90 | `False` | `True` |
| `pool_enemy_dev_enemy_formation_eye_jammer` | `dev_enemy_formation_eye_jammer` | `` | 阵眼干扰怪 | 1 | 90 | `False` | `True` |
| `pool_boss_dev_boss_shield_jinglei` | `` | `dev_boss_shield_jinglei` | 护盾Boss：验证惊雷 | 1 | 90 | `False` | `True` |
| `pool_boss_dev_boss_swarm_lihuo` | `` | `dev_boss_swarm_lihuo` | 群怪Boss：验证离火 | 1 | 90 | `False` | `True` |
| `pool_boss_dev_boss_burst_huzhen` | `` | `dev_boss_burst_huzhen` | 高爆发Boss：验证护阵 | 1 | 90 | `False` | `True` |
| `pool_boss_dev_boss_debuff_jinge` | `` | `dev_boss_debuff_jinge` | 负面状态Boss：验证净厄 | 1 | 90 | `False` | `True` |
| `pool_boss_dev_boss_caster_zhenhun` | `` | `dev_boss_caster_zhenhun` | 施法Boss：验证镇魂 | 1 | 90 | `False` | `True` |
| `pool_boss_dev_boss_energy_juneng` | `` | `dev_boss_energy_juneng` | 供能干扰Boss：验证聚能 | 1 | 90 | `False` | `True` |
| `pool_boss_dev_boss_hybrid_combo` | `` | `dev_boss_hybrid_combo` | 混合机制Boss：验证组合Build | 1 | 90 | `False` | `True` |
...
- Formal 1-10 / 2-10: not connected.
- Formal enemy / Boss / reward / drop / numeric configs: not referenced.
- RunFlow / PageState / FormationState / SaveData / PlayerPrefs / MainTrialProgressData: not touched.
- Current UI scene / RectTransform / hand-tuned layout: not touched.
- FeatureFlags: remain false.

## User Check

- Confirm profiles are marked devOnly and disabled.
- Confirm reports say simulator-readable only.
- Confirm no formal 1-10 / 2-10 content uses this pool.
