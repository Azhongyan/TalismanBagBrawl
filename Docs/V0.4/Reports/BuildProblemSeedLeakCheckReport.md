# Build Problem Seed Leak Check Report
...
- All seed data is static BuildSandbox data and disabled by default.
- DropBias is report-only and does not connect to product drops.
- BossProblem seeds are devOnly Build checks and do not connect to product Boss lists.
- No product stage, save, reward, drop, Boss, UI, V02, or V03 data was edited.
