# BuildSandbox Leak Check Report
...
| `simulationFormalLeaks` | 0 | 0 |

## Forbidden Scope Confirmation

- Formal 1-10 / 2-10 mainline: not connected.
- Formal drop / forge / wash / task / reward flow: not connected.
- RunFlow / PageState / FormationState / V02RunFlowController / V02FormationGridFrame / DamageText: not modified by this report package.
- SaveData / MainTrialProgressData / PlayerPrefs: not read or written by this report package.
- Current formal combat UI and current formal battle-prepare interaction: not modified by this report package.
- This report package does not run FinalIntegrationDryRun01.
