# BuildSandbox Config Panel Report

Package: `V0.4-BuildSandboxConfigPanel01`
Generated: `2026-07-01 10:41:40`
Status: `PASS`
Errors: `0`
Warnings: `0`
...
- Editor-only V0.4 BuildSandbox devOnly config panel.
- Read-only static seed data source: `BuildProblemSeedDataset.CreateDefault()`.
- Menu path: `Tools / Talisman Bag / V0.4 / BuildSandbox / Data / [Manual Only] BuildSandbox Config Panel 01`.
- No V0.2 Stage Config Panel source or V0.2 / V0.3 product data source is edited.
- No formal 1-10 / 2-10, UI scene, save, reward, drop, Boss, or numeric connection.

## Panel Summary

- Window title: `BuildSandbox Config Panel 01`
- Menu path exists: `True`
- Tabs: `10`
- Editable product data: `False`
- Save behavior: `Report export only`
